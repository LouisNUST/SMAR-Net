...
from models.SMAR_R import SMAR_R
from models.SMAR_D import SMAR_D
from utils import custom_transforms
from utils.loss import Img_warp_loss
from utils.utils import save_path_formatter, AverageMeter

parser = argparse.ArgumentParser(description="Self-supervised Multi-scale Adversarial Regression Network.")
